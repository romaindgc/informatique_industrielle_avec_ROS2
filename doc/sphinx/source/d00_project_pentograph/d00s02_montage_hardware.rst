...
.. figure:: resources/img/SSD.jpg
   :align: center
   :width: 30%
Nous identifions deux éléments : le disque SSD proprement dit et un dissipateur thermique (bleu). La première étape consiste à fixer le dissipateur sur le SSD. Pour cela, il suffit de retirer le film protecteur du dissipateur, puis de coller la partie adhésive sur le côté approprié du SSD (face visisble du ssd sur la photo précédente).
